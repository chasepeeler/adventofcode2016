...
//The difference between this and part 1, si that after we visited every node, we'll then add on the distance to return to n0 - which is possible
...
function findDistance($node,$remaining,$all_distances){
	...
	if(empty($remaining)){
		//nothing remaining, so return the distance to get back to n0
		//this is the only difference between part 1 and part 2
		return $all_distances['n0'][$node];
	}
